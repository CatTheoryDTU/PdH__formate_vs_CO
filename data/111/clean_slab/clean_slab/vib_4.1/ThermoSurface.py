...
for i,en in enumerate(vib_energies):
    if np.real(en)==0:
        print(f"Warning: Frequency {i+1} is imaginary (f={en}), setting to 10 meV...")
        vib_energies[i]=0.01
